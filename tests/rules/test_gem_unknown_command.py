...
from thefuck.rules.gem_unknown_command import get_new_command, match
...
def gem_help_commands(mocker: pytest_mock.MockerFixture) -> None:
...
def test_match(script: str, command: str) -> None:
...
def test_get_new_command(script: str, output: str, result: str) -> None:
