...
from thefuck.rules.touch import get_new_command, match
from thefuck.types import Command


def output(is_bsd: bool) -> str:
    if is_bsd:
...
def test_match(script, is_bsd: bool) -> None:
...
def test_get_new_command(script, is_bsd: bool) -> None:
    command = Command(script, output(is_bsd))
