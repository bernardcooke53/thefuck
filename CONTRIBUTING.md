...
if not, just open an issue on [GitHub](https://github.com/bernardcooke53/thefuck) with
...
repository](https://github.com/bernardcooke53/thefuck) for new rules, new features, bug
fixes, etc.
